...
d.tone));h(function(){a.currentPatches=n();c&&history.pushState(n(),null)})}},u=function(b){c({method:"POST",url:q+"/patch/update",timeout:1E4,withCredentials:!0,params:"",data:{name:b,patch:angular.toJson(n()),_csrf:a.csrf},headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},transformRequest:function(a){return $.param(a)}}).success(function(b,c,d,e){h(function(){angular.isObject(b)&&(a.csrf=b.csrf,a.isAuth=b.isAuth,a.patchLists=angular.fromJson(b.patches),angular.forEach(b.message,
function(a){g("Confirmation",500,"auto",!1,"<p><b>"+a+"</b></p>")}))})}).error(function(a,b,d,c){t()})},v=function(b){c({method:"POST",url:q+"/patch/delete",timeout:1E4,withCredentials:!0,params:"",data:{name:b,_csrf:a.csrf},headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},transformRequest:function(a){return $.param(a)}}).success(function(b,c,d,e){angular.isObject(b)&&(a.csrf=b.csrf,a.isAuth=b.isAuth,a.patchLists=angular.fromJson(b.patches),angular.forEach(b.message,function(a){g("Confirmation",
500,"auto",!1,"<p><b>"+a+"</b></p>")}))}).error(function(a,b,d,c){t()})},t=function(){g("Error",500,"auto",!1,"<p><b>Connection to Server failed.</b></p>")};f.onpopstate=function(a){a.state?r(a.state,!1):r(m,!1)};a.isAuth=!1;a.isSignin=!0;a.isSignup=!1;a.isPatchList=!1;a.isSavePath=!1;a.isAccount=!1;a.isDisabled=!1;a.csrf="";a.signups={username:"",password:""};a.signins={username:"",password:""};a.deleteAccounts={username:"",password:""};a.authedUsername="";a.patchname="";a.patchLists=[];a.dialogPatchDetailId=
"dialog-patch-detail";a.isShowDialogPatchDetail=!1;a.$watch(function(){return a.isAuth},function(b){b?(a.signups={username:"",password:""},a.signins={username:"",password:""},a.currentPatches=n(),a.toggleAction(null,"patchList")):(a.deleteAccounts={username:"",password:""},a.currentPatches={},a.patches={},a.patchname="",a.patchLists=[],a.authedUsername="",a.isShowDialogPatchDetail=!1,a.toggleAction(null,"signin"))});a.$on("onOpenPatchDialog",function(b){a.currentPatches=n()});a.cancelClose=function(a){a.stopImmediatePropagation()};
a.toggleAction=function(b,c){null!==b&&b.preventDefault();a.isSignin=!1;a.isSignup=!1;a.isPatchList=!1;a.isSavePatch=!1;a.isAccount=!1;switch(c){case "signin":a.isSignin=!0;break;case "signup":a.isSignup=!0;break;case "patchList":a.isPatchList=!0;break;case "savePatch":a.isSavePatch=!0;break;case "account":a.isAccount=!0}};a.signin=function(b){a.isDisabled=!0;c({method:"POST",url:q+"/account/signin",timeout:1E4,withCredentials:!0,params:"",data:{username:a.signins.username,password:a.signins.password,
_csrf:a.csrf},headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},transformRequest:function(a){return $.param(a)}}).success(function(b,c,d,e){angular.isObject(b)&&(a.csrf=b.csrf,a.isAuth=b.isAuth,a.authedUsername=b.username,a.isAuth?a.patchLists=angular.fromJson(b.patches):angular.forEach(b.message,function(a){g("Error",500,"auto",!1,"<p><b>"+a+"</b></p>")}));a.isDisabled=!1}).error(function(b,c,d,e){t();a.isDisabled=!1})};a.signup=function(b){a.isDisabled=!0;c({method:"POST",
url:q+"/account/signup",timeout:1E4,withCredentials:!0,params:"",data:{username:a.signups.username,password:a.signups.password,_csrf:a.csrf},headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},transformRequest:function(a){return $.param(a)}}).success(function(b,c,d,e){angular.isObject(b)&&(a.csrf=b.csrf,a.isAuth=b.isAuth,a.authedUsername=b.username,a.isAuth?angular.forEach(b.message,function(a){g("Confirmation",600,"auto",!1,"<p><b>"+a+"</b></p>")}):angular.forEach(b.message,
...
a.isDisabled=!1}).error(function(b,c,d,e){t();a.isDisabled=!1})};a.deleteAccount=function(a){$("<div />").html('<p><b>Delete your account. OK ?<br /> <b class="dangerous">If you delete account, the all of patches that you saved are also deleted.</b></b></p>').dialog({title:"Confirmation",autoOpen:!0,show:"bounce",hide:"explode",modal:!1,width:650,height:"auto",draggable:!0,resizable:!1,zIndex:9999,buttons:{OK:function(){p();$(this).dialog("close").dialog("destroy").remove()},CANCEL:function(){$(this).dialog("close").dialog("destroy").remove()}}})};
a.typePatchname=function(b){a.patchname=b.currentTarget.value};a.savePatch=function(b){a.isDisabled=!0;c({method:"POST",url:q+"/patch/add",timeout:1E4,withCredentials:!0,params:"",data:{name:a.patchname,patch:angular.toJson(n()),_csrf:a.csrf},headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},transformRequest:function(a){return $.param(a)}}).success(function(b,c,d,e){angular.isObject(b)&&(a.csrf=b.csrf,a.isAuth=b.isAuth,angular.forEach(b.message,function(a){g("Confirmation",
500,"auto",!1,"<p><b>"+a+"</b></p>")}),b.result&&(a.patchLists=angular.fromJson(b.patches)));a.isDisabled=!1}).error(function(b,c,d,e){t();a.isDisabled=!1})};a.openPatchDetail=function(b,c){if(angular.isObject(c))a.patches=c.patch;else{var e=c.patch.replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&amp;/g,"&");a.patches=angular.fromJson(e)}a.isShowDialogPatchDetail=!0;$("#"+a.dialogPatchDetailId).dialog({title:c.name,autoOpen:!0,show:"explode",hide:"explode",modal:!1,width:600,height:400,draggable:!0,
resizable:!1,zIndex:9999,position:{my:"center top",at:"center top"},buttons:{LOAD:function(){r(a.patches,!0);$(this).dialog("close")},UPDATE:function(){$("<div />").html("<p><b>Update the patch. OK ?</b></p>").dialog({title:"Confirmation",autoOpen:!0,show:"explode",hide:"explode",modal:!1,width:400,height:"auto",draggable:!0,resizable:!1,zIndex:1E4,buttons:{OK:function(){u(c.name);$(this).dialog("close").dialog("destroy").remove();$("#"+a.dialogPatchDetailId).dialog("close")},CANCEL:function(){$(this).dialog("close").dialog("destroy").remove()}}})},
DELETE:function(){$("<div />").html("<p><b>Delete the patch. OK ?</b></p>").dialog({title:"Confirmation",autoOpen:!0,show:"explode",hide:"explode",modal:!1,width:400,height:"auto",draggable:!0,resizable:!1,zIndex:1E4,buttons:{OK:function(){v(c.name);$(this).dialog("close").dialog("destroy").remove();$("#"+a.dialogPatchDetailId).dialog("close")},CANCEL:function(){$(this).dialog("close").dialog("destroy").remove()}}})},CLOSE:function(){$(this).dialog("close")}},close:function(b,c){$(this).dialog("destroy");
h(function(){a.isShowDialogPatchDetail=!1})}})};c({method:"GET",url:q,timeout:1E4,withCredentials:!0,params:"",headers:{}}).success(function(b,c,e,d){angular.isObject(b)&&b.result&&(a.isAuth=b.isAuth,a.csrf=b.csrf,a.authedUsername=b.username,a.isAuth&&(a.patchLists=angular.fromJson(b.patches)))}).error(function(a,b,c,d){t()})}])})();